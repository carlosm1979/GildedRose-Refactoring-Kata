...
describe("Gilded Rose", function() {
  ...
  describe.each([
    {initialSellin: 0, initialQuality: 10, expectedSelling: -1, expectedQuality: 6},
    {initialSellin: -1, initialQuality: 10, expectedSelling: -2, expectedQuality: 6}
  ]
    )(
    'For conjured productsOnce the sell by date has passed, Quality degrades twice as fast',
    (data) => {
      test(`when initial sellin is ${data.initialSellin}`, () => {
        const gildedRose = new Shop([new Item("Conjured", data.initialSellin, data.initialQuality)]);
